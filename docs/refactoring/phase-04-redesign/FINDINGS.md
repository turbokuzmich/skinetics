...
- Initial mobile Lighthouse scored 85 because third-party analytics dominated early loading. Immediate queues plus post-render external loaders reduced TBT from 305 ms to 12 ms and produced a final 92 performance / 100 accessibility score.
