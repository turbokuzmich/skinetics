...
Store design-direction comparisons, approved mockups, token and component inventories, screenshots, accessibility findings, performance reports, and release notes here.

- [Future template composition contracts](./template-composition-contracts.md) — design-level brand, concern, ingredient, and expert page structures, evidence rules, conversions, analytics placements, and the shared publication gate; no routes are published.
